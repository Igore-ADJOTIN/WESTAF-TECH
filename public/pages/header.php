          ...
          <a class="navbar-brand" href="index.php">
            <img src="assets/images/logo/logo1.jpg" class="logo-light" alt="logo">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mr-auto ml-auto">
              <li class="nav__item  has-dropdown">
                <a href="./?Tech=accueil" class="nav__item-link" style="color: white">Accueil</a>
              ...
              <li class="nav__item" >
                <a href="./?Tech=about"  class=" nav__item-link" style="color: white">Présentation</a>
                <!--ul class="dropdown-menu">
                  <li class="nav__item">
              ...
              <li class="nav__item">
                <a href="./?Tech=services" class=" nav__item-link"style="color: white">Nos Services</a>
                <ul class="dropdown-menu wide-dropdown-menu">
                  <li class="nav__item">
                    <div class="row mx-0">
                      <div class="col-sm-6 dropdown-menu-col">
                        <a href="index.php" class="nav__item-link dropdown-menu-title">IT Solutions</a>
              ...
              <li class="nav__item  has-dropdown">
                <a href="./?Tech=media"  class=" nav__item-link"style="color: white">Nouvelles et Media</a>
                <ul class="dropdown-menu">
                  <li class="nav__item">
              ...
              <li class="nav__item">
                <a href="./?Tech=contact" class="nav__item-link" style="color: white;">Contacts</a>
              </li>
            </ul>
          </div>
          <ul class="navbar-actions list-unstyled mb-0 d-flex align-items-center">
            <li>
              <button class="action__btn action__btn-login open-login-popup">
                <i class="icon-user"></i><span>Se Connecter</span>
              </button>
            </li>
            <li class="d-none d-xl-block">
              <a href="request-quote.html" class="btn btn__primary btn__primary-style2 btn_ action__btn-contact" style="background-color: #0E2B5C">Request
                A Quote</a>
            </li>
          </ul><!-- /.navbar-actions -->